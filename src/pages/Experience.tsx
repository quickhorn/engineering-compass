     ...
     <div className="container py-16 md:py-24">
       ...
       <div className="mb-16 max-w-3xl">
         ...
         <p className="text-lg text-muted-foreground">
           15+ years of building teams, shipping products, and empowering engineers—always through the lens of developer experience.
         </p>
       </div>
       ...
       <section className="mt-24 rounded-lg border border-border/50 bg-gradient-to-br from-card/80 to-card/40 p-8 backdrop-blur-sm md:p-12">
         ...
         <div className="max-w-3xl space-y-4 text-muted-foreground">
           <p>
             My career began in the structured world of enterprise software—healthcare systems at ARUP, 
             financial platforms at Academy Mortgage. I learned to build systems that couldn't fail, 
             and discovered my passion for the people behind the code.
           </p>
           <p>
             At Medici Ventures, I took the leap into startup territory. Leading engineering teams in 
             the blockchain space taught me that building great products requires building great teams first. 
             The $4M acquisition of Bitsy validated that approach, but more importantly, watching 100+ 
             developers I hired grow into leaders across the organization showed me the lasting impact 
             of intentional team building.
           </p>
           <p>
             I ventured into entrepreneurship with Inclusive Agile, a DEI-focused training initiative. 
             While market timing proved challenging, the experience deepened my understanding of what 
             it truly means to lead with empathy and build inclusive cultures.
           </p>
           <p className="font-medium text-foreground">
             Today, I bring the stability of enterprise thinking, the agility of startup execution, 
             and hard-won lessons about what makes teams thrive. I'm ready to channel all of this 
             into my next engineering leadership role.
           </p>
         </div>
       </section>
     </div>
